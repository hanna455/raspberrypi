...
step1 = importlib.import_module("tml-solutions.myawesometmlsolutionml-.tml_system_step_1_getparams_dag-myawesometmlsolutionml-")
step2 = importlib.import_module("tml-solutions.myawesometmlsolutionml-.tml_system_step_2_kafka_createtopic_dag-myawesometmlsolutionml-")
step3 = importlib.import_module("tml-solutions.myawesometmlsolutionml-.tml_read_RESTAPI_step_3_kafka_producetotopic_dag-myawesometmlsolutionml-")
step4 = importlib.import_module("tml-solutions.myawesometmlsolutionml-.tml_system_step_4_kafka_preprocess_dag-myawesometmlsolutionml-")
step5 = importlib.import_module("tml-solutions.myawesometmlsolutionml-.tml_system_step_5_kafka_machine_learning_dag-myawesometmlsolutionml-")
step6 = importlib.import_module("tml-solutions.myawesometmlsolutionml-.tml_system_step_6_kafka_predictions_dag-myawesometmlsolutionml-")
step7 = importlib.import_module("tml-solutions.myawesometmlsolutionml-.tml_system_step_7_kafka_visualization_dag-myawesometmlsolutionml-")
step8 = importlib.import_module("tml-solutions.myawesometmlsolutionml-.tml_system_step_8_deploy_solution_to_docker_dag-myawesometmlsolutionml-")
step9 = importlib.import_module("tml-solutions.myawesometmlsolutionml-.tml_system_step_9_privategpt_qdrant_dag-myawesometmlsolutionml-")
step10 = importlib.import_module("tml-solutions.myawesometmlsolutionml-.tml_system_step_10_documentation_dag-myawesometmlsolutionml-")


with DAG(
    dag_id="solution_preprocessing_ml_ai_restapi_dag-myawesometmlsolutionml-",

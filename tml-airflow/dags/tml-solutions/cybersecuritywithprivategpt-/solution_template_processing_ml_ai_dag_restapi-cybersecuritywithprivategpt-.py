...
step1 = importlib.import_module("tml-solutions.cybersecuritywithprivategpt-.tml_system_step_1_getparams_dag-cybersecuritywithprivategpt-")
step2 = importlib.import_module("tml-solutions.cybersecuritywithprivategpt-.tml_system_step_2_kafka_createtopic_dag-cybersecuritywithprivategpt-")
step3 = importlib.import_module("tml-solutions.cybersecuritywithprivategpt-.tml_read_RESTAPI_step_3_kafka_producetotopic_dag-cybersecuritywithprivategpt-")
step4 = importlib.import_module("tml-solutions.cybersecuritywithprivategpt-.tml_system_step_4_kafka_preprocess_dag-cybersecuritywithprivategpt-")
step5 = importlib.import_module("tml-solutions.cybersecuritywithprivategpt-.tml_system_step_5_kafka_machine_learning_dag-cybersecuritywithprivategpt-")
step6 = importlib.import_module("tml-solutions.cybersecuritywithprivategpt-.tml_system_step_6_kafka_predictions_dag-cybersecuritywithprivategpt-")
step7 = importlib.import_module("tml-solutions.cybersecuritywithprivategpt-.tml_system_step_7_kafka_visualization_dag-cybersecuritywithprivategpt-")
step8 = importlib.import_module("tml-solutions.cybersecuritywithprivategpt-.tml_system_step_8_deploy_solution_to_docker_dag-cybersecuritywithprivategpt-")
step9 = importlib.import_module("tml-solutions.cybersecuritywithprivategpt-.tml_system_step_9_privategpt_qdrant_dag-cybersecuritywithprivategpt-")
step10 = importlib.import_module("tml-solutions.cybersecuritywithprivategpt-.tml_system_step_10_documentation_dag-cybersecuritywithprivategpt-")


with DAG(
    dag_id="solution_preprocessing_ml_ai_restapi_dag-cybersecuritywithprivategpt-",
